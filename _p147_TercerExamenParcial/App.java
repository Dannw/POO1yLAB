...
public class App extends JFrame implements ActionListener {
    ...
    JDialog jdlAcercaDe;
    JLabel lblDatos, lblNombre, lblEdad, lblPeso, lblSexo, lblEstadoCivil, lblDescripción, lblSalario;
    JTextField txtNombre, txtEdad, txtPeso, txtSexo, txtEstadoCivil, txtDescripción, txtSalario;
    JScrollPane spane;
    JTable table;
    ...
    public App() {
        ...
        lblDatos = new JLabel("<html>Tercer Examen Parcial <br>Daniel Varela garcía</html>", JLabel.CENTER);
        lblDatos.setFont(new Font("Cambria", Font.BOLD, 18));
        ...
        pnlDatos = new JPanel();
        add(pnlDatos);
        pnlDatos.setLayout(new GridLayout(3, 2, 0, 0));
    ...
    public void cargarDatos() {
        ...
        for (int i = 0; i < datos.size(); i++) {
            ...
            obj[4] = datos.get(i).getDescripción();
    ...
    public void guardarCampos() {
        ...
        jug.setDescripción(txtDescripción.getText());
