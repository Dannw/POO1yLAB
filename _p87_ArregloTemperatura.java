...
public class _p87_ArregloTemperatura {
    ...
    public static void main(String[] args) {
        double[] temps = {12.34, 56.22, 56.78, 0.0, 10.25, 60.22, 10.0  };
        ...
        if(pos!=-1)
            System.out.println("El elemento fue encontrado en la posición " + pos);
        else 
            System.out.println("\nEl elemento a buscar no existe en el arreglo de temperaturas");
    }
